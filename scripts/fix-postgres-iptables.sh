...
echo ""
echo "Option 1: Update rule to forward to port 5432 (if container IP is 142.4.216.160):"
echo "  sudo iptables -t nat -D PREROUTING 17"
echo "  sudo iptables -t nat -A PREROUTING -p tcp --dport 5432 -j DNAT --to-destination 142.4.216.160:5432"
echo ""
